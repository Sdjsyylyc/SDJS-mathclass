...
class Scene1Ellipse(MovingCameraScene):
    def construct(self):
        ...
        self.play(AnimationGroup(AnimationGroup(AnimationGroup(FadeOut(focus_right), FadeOut(focus_left), FadeOut(pf1_line), FadeOut(pf2_line)), AnimationGroup(FadeOut(p_dot)), run_time=1.5, lag_ratio=0.5)))
